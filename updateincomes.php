...
$incomes = inc_details($pdo, $inc_id);
...
if (!empty($_POST)) {
    ...
    if (empty($errors)) {
        ...
        if (updateAmount($pdo, $inc_id, $inc_amount, $inc_receipt_date, $inc_cat_id)) {
        ...
        <div class="col-md-4">
            ...
            <form id="form-update" class="text-center" action="" method="post">
                <div class="mb-3">
                    ...
                    <input name="inc_amount" class="form-control" id="inc_amount" type="number" value="<?= $incomes['inc_amount'] ?>">
                ...
                <div class="mb-3 mx-auto" style="width:200px;">
                    ...
                    <input type="date" value="<?= date('Y-m-d',strtotime($incomes['inc_receipt_date'])) ?>" name="inc_receipt_date" class="form-control">
                ...
                <div class="mb-3 mx-auto" style="width:200px;">
                    ...
                    <select name="inc_cat_id" class="form-select" id="inc">
                        <?php foreach ($inc_cats as $inc_cat) : ?>
                            <option <?= $incomes['inc_cat_id']==$inc_cat['inc_cat_id'] ? 'selected' : '' ?> value="<?= $inc_cat['inc_cat_id'] ?>"><?= $inc_cat['inc_cat_name'] ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
